...
var f1info_schema_1 = require("../../f1info/f1info.schema");
...
var UsersDao = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = new this.User(__assign(__assign({ _id: userId }, userFields), { permissionFlags: 1 }));
    ...
    UsersDao.prototype.getUserById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.User.findOne({ _id: userId }).exec()]; //tenía .populate('User') antes de exec. Pero crasheaba porque?
            });
        });
    };
    ...
    UsersDao.prototype.getUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.User.find().exec()];
            });
        });
    };
    ...
    UsersDao.prototype.removeUserById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.User.deleteOne({ _id: userId }).exec()];
            });
        });
    };
    ...
    UsersDao.prototype.setResetHash = function (email, hash) {
        return __awaiter(this, void 0, void 0, function () {
            var userFields;
            return __generator(this, function (_a) {
                userFields = { resetHash: hash };
                try {
                    return [2 /*return*/, this.User.findOneAndUpdate({ email: email }, { $set: userFields })];
                }
                catch (error) {
                    return [2 /*return*/, -1];
                }
